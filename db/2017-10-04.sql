...
insert  into `menu_link`(`id`,`menu_id`,`link`,`parent_id`,`image`,`alwaysVisible`,`order`,`created_at`,`updated_at`,`created_by`,`updated_by`) values ('aboutid','footer-main','/who-we-are','','',1,999,1506337397,1506342061,1,1),('about_id','main-menu','/site/who-we-are','','',1,0,1505730974,1505730974,1,1),('app_id','main-menu','/site/mobile-app-development','serv_id','',1,5,1505731733,1505731733,1,1),('block','admin-menu','/block/default/index','','clone',0,24,NULL,NULL,1,NULL),('career_id','footer-main','/careers','','',1,999,1506337466,1506342081,1,1),('car_id','main-menu','/site/careers','','',1,15,1506062888,1506062888,1,1),('client_id','admin-menu','/clients','','',1,2,1506433152,1506433152,1,1),('clouds_id','footer-tech','/cloud','','',1,999,1506337550,1506342520,1,1),('cloud_id','main-menu','/site/cloud','tech_id','',1,12,1505736769,1505736769,1,1),('cms_id','main-menu','/site/cms','platform_id','',1,8,1505733419,1505733419,1,1),('cm_id','footer-platform','/cms','','',1,999,1506337751,1506343412,1,1),('comment','admin-menu','/comment/default/index','','comment',0,16,NULL,NULL,1,NULL),('contact','main-menu','/site/contact-sumanas','','',1,16,NULL,1505887480,1,1),('contact_id','footer-main','/contact-sumanas','','',1,999,1506337491,1506342089,1,1),('crm_id','main-menu','/site/crm','platform_id','',1,9,1505735946,1505735946,1,1),('cr_id','footer-platform','/crm','','',1,999,1506337771,1506343419,1,1),('dashboard','admin-menu','/','','th',0,0,NULL,NULL,1,NULL),('dev_id','footer-serv','/website-development','','',1,999,1506337655,1506343379,1,1),('digi_id','footer-serv','/digital-marketing','','',1,999,1506337676,1506343395,1,1),('dig_id','main-menu','/site/digital-marketing','serv_id','',1,4,1505731360,1505731360,1,1),('ecomm_id','footer-platform','/e-commerce','','',1,999,1506337793,1506343425,1,1),('ecom_id','main-menu','/site/e-commerce','platform_id','',1,10,1505736233,1505736233,1,1),('general_id','admin-menu','/general-settings','','',1,32,1506409685,1506409734,1,1),('image-settings','admin-menu','/media/default/settings','settings',NULL,0,29,NULL,NULL,1,NULL),('media','admin-menu',NULL,'','image',0,12,NULL,NULL,1,NULL),('media-album','admin-menu','/media/album/index','media',NULL,0,14,NULL,NULL,1,NULL),('media-category','admin-menu','/media/category/index','media',NULL,0,15,NULL,NULL,1,NULL),('media-media','admin-menu','/media/default/index','media',NULL,0,13,NULL,NULL,1,NULL),('menu','admin-menu','/menu/default/index','','align-justify',0,17,NULL,NULL,1,NULL),('mob_id','footer-serv','/mobile-app-development','','',1,999,1506337697,1506343388,1,1),('open_id','main-menu','/site/opensource','tech_id','',1,13,1505736978,1505736978,1,1),('page','admin-menu','/page/default/index','','file',0,1,NULL,NULL,1,NULL),('platform_id','main-menu','/site/platform','','',1,7,1505733143,1505733143,1,1),('portcat_id','admin-menu','/portfolio/portfoliocategory','portfo_id','',1,7,1507022324,1507022324,1,1),('portfolio_id','admin-menu','/portfolio','portfo_id','',1,6,1507022187,1507022483,1,1),('portfo_id','admin-menu','','','',1,5,1507022500,1507022580,1,1),('port_id','main-menu','/site/portfolio','','',1,14,1506157940,1506157940,1,1),('post','admin-menu',NULL,'','pencil',0,8,NULL,NULL,1,NULL),('post-category','admin-menu','/post/category/index','post',NULL,0,11,NULL,NULL,1,NULL),('post-post','admin-menu','/post/default/index','post',NULL,0,9,NULL,NULL,1,NULL),('post-tag','admin-menu','/post/tag/index','post',NULL,0,10,NULL,NULL,1,NULL),('product_id','footer-main','/products','','',1,999,1506337430,1506342098,1,1),('pro_id','main-menu','/site/products','','',1,6,1505731984,1505731984,1,1),('seo','admin-menu','/seo/default/index','','line-chart',0,25,NULL,NULL,1,NULL),('serv_id','main-menu','/site/services-overview','','',1,1,1505728882,1505728882,1,1),('settings','admin-menu',NULL,'','cog',0,26,NULL,NULL,1,NULL),('settings-cache','admin-menu','/settings/cache/flush','settings',NULL,0,31,NULL,NULL,1,NULL),('settings-general','admin-menu','/settings/default/index','settings',NULL,0,27,NULL,NULL,1,NULL),('settings-reading','admin-menu','/settings/reading/index','settings',NULL,0,28,NULL,NULL,1,NULL),('settings-translations','admin-menu','/translation/default/index','settings',NULL,0,30,NULL,NULL,1,NULL),('source_id','footer-tech','/opensource','','',1,999,1506337579,1506342526,1,1),('team_id','admin-menu','/team','','',1,4,1506607744,1506607744,1,1),('tech_id','main-menu','/site/technologies','','',1,11,1505736530,1505736530,1,1),('test-page','main-menu','/site/test','about',NULL,1,7,NULL,NULL,1,NULL),('ui_id','main-menu','/site/ui-ux-design','serv_id','',1,2,1505543079,1505543079,1,1),('user','admin-menu',NULL,'','user',0,18,NULL,NULL,1,NULL),('user-groups','admin-menu','/user/permission-groups/index','user',NULL,0,22,NULL,NULL,1,NULL),('user-log','admin-menu','/user/visit-log/index','user',NULL,0,23,NULL,NULL,1,NULL),('user-permission','admin-menu','/user/permission/index','user',NULL,0,21,NULL,NULL,1,NULL),('user-role','admin-menu','/user/role/index','user',NULL,0,20,NULL,NULL,1,NULL),('user-user','admin-menu','/user/default/index','user',NULL,0,19,NULL,NULL,1,NULL),('ux_id','footer-serv','/ui-ux-design','','',1,999,1506337635,1506343371,1,1),('web_id','main-menu','/site/website-development','serv_id','',1,3,1505730286,1505730286,1,1),('work_id','admin-menu','/works','','',1,3,1506503725,1506503725,1,1);
...
CREATE TABLE `portfolio` (
  ...
  `slug` varchar(255) NOT NULL,
  `title` varchar(255) NOT NULL,
  `sub_title` varchar(510) NOT NULL,
  `description` text,
  `client` varchar(255) NOT NULL,
  `portfolio_date` int(11) DEFAULT NULL,
  `portfolio_link` varchar(510) NOT NULL,
  `thumbnail` varchar(255) DEFAULT NULL,
  `visible` int(11) NOT NULL DEFAULT '1' COMMENT '0-hidden,1-visible',
  `created_at` int(11) DEFAULT NULL,
  `updated_at` int(11) DEFAULT NULL,
  ...
  `updated_by` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_portfolio_created_by` (`created_by`),
  KEY `fk_portfolio_updated_by` (`updated_by`),
  CONSTRAINT `fk_portfolio_created_by` FOREIGN KEY (`created_by`) REFERENCES `user` (`id`) ON DELETE SET NULL ON UPDATE CASCADE,
  CONSTRAINT `fk_portfolio_updated_by` FOREIGN KEY (`updated_by`) REFERENCES `user` (`id`) ON DELETE SET NULL ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8;

/*Data for the table `portfolio` */

insert  into `portfolio`(`id`,`slug`,`title`,`sub_title`,`description`,`client`,`portfolio_date`,`portfolio_link`,`thumbnail`,`visible`,`created_at`,`updated_at`,`created_by`,`updated_by`) values (2,'dashboard','Dashboard','Web Design/Graphic','ghjghjgy','hgjghj',1506988800,'ghgg','/uploads/2017/10/480x2504f4e75.png',1,1507023580,1507096790,1,1),(3,'world-clock-widget','World Clock Widget','Logo/Web Design','nbjhjg','ljkljl',1506988800,'jkhhhhhhhhkh','/uploads/2017/10/a.png',1,1507037593,1507096576,1,1),(4,'events-and-more','Events And More','Web Design/Graphic','hgjghj','jghj',1506988800,'jhjhj','/uploads/2017/10/b.png',1,1507038274,1507038274,1,1);
...
CREATE TABLE `portfolio_category` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_portfolio_category_created_by` (`created_by`),
  KEY `fk_portfolio_category_updated_by` (`updated_by`),
  CONSTRAINT `fk_portfolio_category_created_by` FOREIGN KEY (`created_by`) REFERENCES `user` (`id`) ON DELETE SET NULL ON UPDATE CASCADE,
  CONSTRAINT `fk_portfolio_category_updated_by` FOREIGN KEY (`updated_by`) REFERENCES `user` (`id`) ON DELETE SET NULL ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8;

/*Data for the table `portfolio_category` */

insert  into `portfolio_category`(`id`,`slug`,`title`,`description`,`visible`,`created_at`,`updated_at`,`created_by`,`updated_by`,`left_border`,`right_border`,`depth`) values (1,'root','',NULL,0,1507016325,NULL,NULL,NULL,0,2147483647,0),(3,'identity','Identity','',1,1507021815,1507021988,1,1,294752655,336860176,1),(4,'web-design','Web Design','',1,1507021919,1507021919,1,1,126322567,168430088,1),(5,'graphic','Graphic','',1,1507021943,1507021956,1,1,210537611,252645132,1),(6,'logo','Logo','',1,1507022008,1507022008,1,1,378967699,421075220,1);

/*Table structure for table `portfolio_category_portfolio` */

DROP TABLE IF EXISTS `portfolio_category_portfolio`;

CREATE TABLE `portfolio_category_portfolio` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `portfolio_id` int(11) DEFAULT NULL,
  `portfolio_category_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_portfolio_category_portfolio_id` (`portfolio_id`),
  KEY `fk_portfolio_category_category_id` (`portfolio_category_id`),
  CONSTRAINT `fk_portfolio_category_category_id` FOREIGN KEY (`portfolio_category_id`) REFERENCES `portfolio_category` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_portfolio_category_portfolio_id` FOREIGN KEY (`portfolio_id`) REFERENCES `portfolio` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8;

/*Data for the table `portfolio_category_portfolio` */

insert  into `portfolio_category_portfolio`(`id`,`portfolio_id`,`portfolio_category_id`) values (8,2,6),(9,4,4),(11,3,5);
...
CREATE TABLE `portfolio_images` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_portfolio_images_portfolio_id` (`portfolio_id`),
  CONSTRAINT `fk_portfolio_images_portfolio_id` FOREIGN KEY (`portfolio_id`) REFERENCES `portfolio` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8;

/*Data for the table `portfolio_images` */

insert  into `portfolio_images`(`id`,`portfolio_id`,`image`) values (1,2,'/uploads/2017/09/team3-400x300.jpg');
