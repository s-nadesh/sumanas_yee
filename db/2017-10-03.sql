...
insert  into `portfolio`(`id`,`slug`,`title`,`sub_title`,`description`,`client`,`portfolio_date`,`portfolio_link`,`thumbnail`,`visible`,`created_at`,`updated_at`,`created_by`,`updated_by`) values (2,'dashboard','Dashboard','Web Design/Graphic','ghjghjgy','hgjghj',1506988800,'ghgg','/uploads/2017/10/480x250d06583-400x300.png',1,1507023580,1507023580,1,1);
...
insert  into `portfolio_category_portfolio`(`id`,`portfolio_id`,`portfolio_category_id`) values (4,2,3);
