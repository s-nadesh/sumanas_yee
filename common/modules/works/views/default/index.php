...
$this->title = Yii::t('yee/media', 'Works');
$this->params['breadcrumbs'][] = ['label' => Yii::t('yee/post', 'Works'), 'url' => ['default/index']];
        ...
        <div class="panel-body">
            ...
            <div class="row">
                <div class="col-sm-12 text-right">
                    <?= GridPageSize::widget(['pjaxId' => 'works-grid-pjax']) ?>
                </div>
            </div>

            <?php Pjax::begin(['id' => 'works-grid-pjax']) ?>
            ...
            <?= GridView::widget([
                ...
                'columns' => [
                    ...
                    [
                        ...
                        'controller' => '/works/default',
                        'title' => function (Works $model) {
